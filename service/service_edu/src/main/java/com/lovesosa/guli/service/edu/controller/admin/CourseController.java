...
import com.lovesosa.guli.service.edu.entity.vo.CourseQueryVo;
...
public class CourseController {
    ...
    public R updateCourseInfo(@ApiParam(value = "课程简介",required = true)
    ...
    public R listP(@ApiParam(value = "当前页码",required = true) @PathVariable("page") Long page,
